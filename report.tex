...
{ 	\boxed{
		...
		\\ \quad	\text{averge}
		\\	\text{4. Select one more point randomly with replacement }
		\\ \quad	\text{since the result should not be biased and chosing}
		\\ \quad	\text{a random point is independent of the choice }
		\\ \quad	\text{of sample made earlier }
